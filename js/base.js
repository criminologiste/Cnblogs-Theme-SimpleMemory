...
//                    color: 'random',
    ...
    this.setNotHomeTopImg = function() {
        ...
        $('.main-header').css('background', '#222 url(https://www.cnblogs.com/images/cnblogs_com/icaihua/1287364/o_wallhaven-666357.jpg)  center center no-repeat');
