...
$(document).ready(function(){
    ...
    var bottom_html = '<br><p style="padding-top: 0; padding-right: 10px; padding-bottom: 10px; padding-left: 70px; background: url(https://files.cnblogs.com/files/icaihua/cat.gif) #f7f7f7 no-repeat 12.5px 50%; font-family: 微软雅黑; font-size: 12px; border: #e0e0e0 1px dashed;">';
    bottom_html += '<br>';
    ...
    if (articleAuthor != undefined && articleSource != undefined) {
        ...
        bottom_html += '<a href="http://www.cnblogs.com/icaihua/" target="_blank">Damon°</a></span></strong> <br>';
        bottom_html += '<span style="font-weight: bold;color: #333; white-space:nowrap;">出　　处</span>：<a href="http://www.cnblogs.com/icaihua/" target="_blank">http://www.cnblogs.com/icaihua/</a>';
    } else {
